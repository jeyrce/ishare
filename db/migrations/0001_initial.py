# Generated by Django 2.0.7 on 2019-04-02 17:35
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Blog',
            fields=[
                ('id', models.CharField(default=shortuuid.main.ShortUUID.uuid, max_length=12, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reply', DjangoUeditor.models.UEditorField(blank=True, max_length=300, verbose_name='回复')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cat', models.PositiveSmallIntegerField(choices=[(0, '订阅推送'), (1, '友链推送')], verbose_name='推送类型')),
                ('total', models.PositiveIntegerField(default=0, verbose_name='发送条数')),
                ('success', models.PositiveIntegerField(default=0, verbose_name='成功条数')),
        ...
        migrations.CreateModel(
            name='Focus',
            fields=[
                ('id', models.EmailField(max_length=32, primary_key=True, serialize=False, verbose_name='邮箱')),
                ('add', models.DateTimeField(auto_now_add=True, verbose_name='添加时间')),
                ('mod', models.DateTimeField(auto_now=True, verbose_name='最近修改')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cat', models.PositiveSmallIntegerField(choices=[(0, '个人博客'), (1, '公益链接'), (2, '商业广告')], default=0, verbose_name='链接类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mod', models.DateTimeField(default=None, null=True, verbose_name='回复时间')),
        ...
        migrations.CreateModel(
            name='Visitor',
            fields=[
                ('id', models.EmailField(help_text='最多32字符', max_length=32, primary_key=True, serialize=False, verbose_name='邮箱')),
        ...
        migrations.AddField(
            model_name='comment',
            name='visitor',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='db.Visitor', verbose_name='评论者'),
        ),
        migrations.AddField(
            model_name='click',
            name='link',
